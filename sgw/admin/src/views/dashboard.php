    ...
    <div class="tab-panel active" id="panel-logs">
      <div class="card">
        ...
        <div class="log-controls">
          <div class="log-filter" id="filter-ip" role="textbox" aria-label="过滤 IP" tabindex="0" contenteditable="true" data-placeholder="过滤 IP" spellcheck="false" data-lpignore="true" data-1p-ignore="true" onpaste="pastePlainText(event)" onkeydown="if(event.key==='Enter'){event.preventDefault();this.blur()}" oninput="logPage=1;renderLogs()"></div>
          <div class="log-filter" id="filter-status" role="textbox" aria-label="状态码 如 403" tabindex="0" inputmode="numeric" contenteditable="true" data-placeholder="状态码 如 403" spellcheck="false" data-lpignore="true" data-1p-ignore="true" onpaste="pastePlainText(event)" onkeydown="if(event.key==='Enter'){event.preventDefault();this.blur()}" oninput="logPage=1;renderLogs()"></div>
          <div class="log-filter" id="filter-token" role="textbox" aria-label="过滤 Token（自动去重）" tabindex="0" contenteditable="true" data-placeholder="过滤 Token（自动去重）" spellcheck="false" data-lpignore="true" data-1p-ignore="true" onpaste="pastePlainText(event)" onkeydown="if(event.key==='Enter'){event.preventDefault();this.blur()}" oninput="logPage=1;renderLogs()"></div>
